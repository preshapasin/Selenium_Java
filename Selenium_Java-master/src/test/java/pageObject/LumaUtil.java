...
public class LumaUtil {
    ...
    public void sizeColourJackets(List<List<String>> data) {
       // System.out.println("Select size and colour of product");
...
//        System.out.println(priceExp, priceAct);
//        System.out.println(expectedM, actualM);
//        System.out.println(priceExpM, priceActM);
//        System.out.println(expected33, actual33);
//        System.out.println(priceExp33, priceAct33);
